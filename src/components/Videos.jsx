...
const Videos = () => {
  ...
  return (
    <Stack direction={['column', 'row']} h={'120vh'} marginTop={'1rem'}>
      <Stack>
        <VStack w={'full'}>
          <video
            controls
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowX={'auto'}>
          ...
          <Text>
            This is a sample video for testing. Lorem ipsum dolor sit amet
            consectetur, adipisicing elit. Quam, officiis maxime? Quis
            laboriosam tenetur recusandae cum itaque ipsum molestiae excepturi
            atque? Totam maxime placeat, necessitatibus pariatur rerum possimus
            odio voluptatem, modi porro a nobis impedit. Dolorum, facere soluta.
            Eos corporis earum quisquam laudantium perferendis esse recusandae
            ducimus magnam dicta beatae!
          </Text>
        </VStack>
      </Stack>
      <VStack
